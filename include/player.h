...
//#define PLAYER_ERROR_CLASS          TIZEN_ERROR_PLAYER | 0x20  //is blocked temporary to avoid build error until libmm-player is updated
...
typedef enum
{
 ...
 #else
	PLAYER_ERROR_FEATURE_NOT_SUPPORTED_ON_DEVICE	 = TIZEN_ERROR_NONE,	 /*temp value, to avoid build error*/ 
 #endif
